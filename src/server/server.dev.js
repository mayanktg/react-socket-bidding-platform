...
const app = express();
//set env vars
process.env.MONGOLAB_URI = process.env.MONGOLAB_URI || 'mongodb://localhost/bid_dev';
...
require('./routes/bid_routes')(bidRouter);
...
app.get('/*', function(req, res) {
  ...
  match({ routes, location }, (err, redirectLocation, renderProps) => {
    ...
    if (!username && req.get('cookie') ) {
      const getCookie = req.get('cookie');
      username = readCookie('username', getCookie);
    }
